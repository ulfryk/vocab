...
statsBemTools = bem "game-stats-bar"
statsBlockClass = getRootClass statsBemTools
statsElemModClass = getElemModsClassFactory statsBemTools
statsItemClass = statsElemModClass "stat"
...
count stat =
    if (size stat) == 0 then text ""
    else span [] [ text << fromInt << size <| stat ]
