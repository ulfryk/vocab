...
{
	if (region.L.z === region.T.z)
	{
		return 'on line ' + region.L.z;
	}
	return 'on lines ' + region.L.z + ' through ' + region.T.z;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { G: 'hidden', aC: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { G: 'mozHidden', aC: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { G: 'msHidden', aC: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { G: 'webkitHidden', aC: 'webkitvisibilitychange' }
		: { G: 'hidden', aC: 'visibilitychange' };
}
...
var $author$project$State$Splash = {$: 0};
var $elm$core$Set$Set_elm_builtin = $elm$core$Basics$identity;
var $elm$core$Dict$RBEmpty_elm_builtin = {$: -2};
var $elm$core$Dict$empty = $elm$core$Dict$RBEmpty_elm_builtin;
var $elm$core$Set$empty = $elm$core$Dict$empty;
var $author$project$State$mock = _List_fromArray(
	[
		{O: 'dupa', Q: 'arse', Z: '0000'},
		{O: 'fiut', Q: 'dick', Z: '0010'},
		{O: 'kutasiarz', Q: 'asshole', Z: '0100'},
		{O: 'zjeb', Q: 'cunt', Z: '0011'},
		{O: 'cipka', Q: 'pussy', Z: '0101'}
	]);
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$State$initial = {ay: $elm$core$Set$empty, aB: $author$project$State$mock, G: $elm$core$Set$empty, aK: -1, A: $author$project$State$Splash};
...
var $author$project$State$ASide = 0;
var $author$project$State$Both = 2;
var $author$project$State$Done = {$: 3};
...
var $author$project$State$getAvailableCards = function (_v0) {
	var cards = _v0.aB;
	var hidden = _v0.G;
	var archived = _v0.ay;
	var scope = _v0.A;
	return A2(
		...
		function (c) {
			return (!A2($elm$core$Set$member, c.Z, hidden)) && ((!A2($elm$core$Set$member, c.Z, archived)) && function () {
				if (scope.$ === 2) {
					var card = scope.b;
					return !_Utils_eq(c.Z, card.Z);
				} else {
					return true;
				}
			}());
...
var $author$project$State$getNthCard = function (n) {
	return A2(
		...
		$author$project$State$getAvailableCards);
};
...
var $author$project$Play$SetNth = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$playNthCard = function (n) {
	return $author$project$Main$Play(
		$author$project$Play$SetNth(n));
};
...
var $author$project$State$rollRandomCardIndex = function (m) {
	return A2(
		$elm$random$Random$int,
		0,
		$elm$core$List$length(
			$author$project$State$getAvailableCards(m)) - 1);
};
				...
				case 0:
					return _Utils_Tuple2(
						...
						A2(
							...
							$author$project$Main$playNthCard,
							$author$project$State$rollRandomCardIndex(model)));
				case 5:
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{A: $author$project$State$Splash}),
						$elm$core$Platform$Cmd$none);
				case 2:
					var id = m.a;
					var ml = _Utils_update(
						model,
						{
							G: A2($elm$core$Set$insert, id, model.G)
						});
					return _Utils_Tuple2(
						ml,
						A2(
							$elm$random$Random$generate,
							$author$project$Main$playNthCard,
							$author$project$State$rollRandomCardIndex(ml)));
				case 3:
					var id = m.a;
					var ml = _Utils_update(
						model,
						{
							ay: A2($elm$core$Set$insert, id, model.G)
						});
					return _Utils_Tuple2(
						ml,
						A2(
				...
				case 1:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								A: A2($author$project$State$Playing, 2, card)
							}),
						$elm$core$Platform$Cmd$none);
				default:
					var n = m.a;
					var _v2 = A2($author$project$State$getNthCard, n, model);
					if (!_v2.$) {
						var card = _v2.a;
						return _Utils_Tuple2(
							_Utils_update(
								...
								{
									aK: n,
									A: A2($author$project$State$Playing, 0, card)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{aK: n, A: $author$project$State$Done}),
							$elm$core$Platform$Cmd$none);
					}
			}
		} else {
...
var $author$project$Play$Start = {$: 0};
var $elm$html$Html$button = _VirtualDom_node('button');
var $author$project$Play$Drop = function (a) {
	return {$: 3, a: a};
};
var $author$project$Play$Next = function (a) {
	return {$: 2, a: a};
};
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(card.O + (' --> ' + card.Q))
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Play$Next(card.Z))
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Play$Drop(card.Z))
								]),
							_List_fromArray(
								[
...
var $author$project$Layout$progress = function (m) {
	var total = $elm$core$List$length(m.aB);
					...
					case 0:
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Main$Play($author$project$Play$Start))
								]),
							_List_fromArray(
								[
				...
				A2(
					...
					function (c) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text(c.Z + (':: ' + (c.O + (' / ' + c.Q))))
								]));
					},
					$author$project$State$getAvailableCards(model)))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aH: $author$project$Main$initialModel, aT: $author$project$Main$subscriptions, aW: $author$project$Main$update, aX: $author$project$Main$view});
